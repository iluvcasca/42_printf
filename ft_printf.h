...
void					printf_putchar(t_lexer_status *lexer_status,
							void *current_char);
...
void					lexer_type2(char **format, t_lexer_status *lexer_status,
							va_list ap);
void					printf_width(t_lexer_status *lexer_status,
...
void					printf_convert_pointer(uintptr_t p,
...
void					printf_integer_write(t_lexer_status *lexer_status,
...
void					printf_integer_prefix(t_lexer_status *lexer_status,
							int int_value);
...
void					printf_convert_hexa(unsigned int x,
...
void printf_hex_wrapper(t_lexer_status * lexer_status, unsigned int arg, char * l_hex_str, size_t l_hex_len);
