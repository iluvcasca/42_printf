...
/*   Updated: 2023/12/27 16:02:57 by kgriset          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	printf_u_integer_write(t_lexer_status *lexer_status, char *u_int_str,
		size_t u_int_len)
{
	if (lexer_status->precision.exist
		&& (size_t)lexer_status->precision.value > u_int_len)
		printf_width(lexer_status, lexer_status->precision.value - u_int_len,
			'0');
