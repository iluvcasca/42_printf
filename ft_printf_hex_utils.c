...
/*   Updated: 2023/12/27 16:02:05 by kgriset          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	printf_hex_write(t_lexer_status *lexer_status, char *l_hex_str,
		size_t l_hex_len)
{
	...
	if (lexer_status->precision.exist
		&& (size_t)lexer_status->precision.value > l_hex_len)
		printf_width(lexer_status, lexer_status->precision.value - l_hex_len,
			'0');
